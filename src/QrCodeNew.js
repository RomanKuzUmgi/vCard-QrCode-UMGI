 ...
 * @param vCard.url2 {string} - A URL2 pointing to a website that represents the person in some way.
...
QrCode.prototype.createVCard = function (vCard) {
    ...
    if (vCard.url2) {
        formattedVCardString += 'URL' + encodingPrefix + ':' + e(vCard.url2) + nl();
    }

    if (vCard.url3) {
        formattedVCardString += 'URL' + encodingPrefix + ':' + e(vCard.url3) + nl();
    }

    if (vCard.url4) {
        formattedVCardString += 'URL' + encodingPrefix + ':' + e(vCard.url4) + nl();
    }

    if (vCard.url5) {
        formattedVCardString += 'URL' + encodingPrefix + ':' + e(vCard.url5) + nl();
    }
